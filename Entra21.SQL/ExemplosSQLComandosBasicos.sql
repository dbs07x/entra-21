...
INSERT INTO trabalhos
	...
	'Como degustar uma pizza calabresa',
...
INSERT INTO trabalhos
	...
	'Importante para aprender fifo, fefo, lifo, listas encadeadas',
	'1980-05-11',
	'Leitura técnica');
...
INSERT INTO trabalhos
	...
	'Compre frango e batata palha, jogue na panela, acenda o fogão, espera 5 minutinhos e ta plonto o servetinho',
	'2000-09-10',
	'Receita');
...
-- Concatenar informações de duas colunas
SELECT
...
SELECT id, titulo, data_publicacao
	FROM trabalhos
	WHERE
		YEAR(data_publicacao) >= 1999 AND
		YEAR(data_publciacao) <= 2010;
...
-- Consultar data pulbicação formatando no padrão BR, utilizando função para isso
