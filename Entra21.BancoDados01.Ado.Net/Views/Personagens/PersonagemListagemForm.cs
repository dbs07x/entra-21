...
namespace Entra21.BancoDados01.Ado.Net.Views.Personagens
{
    public partial class PersonagemListagemForm : Form
    {
        ...
        Propriedades necessárias e execução de métodos obrigatórios, ou seja,
        neste cenário desenhar a tela e instanciar o objeto do serviço que
        permitirá gerenciar os dados referente ao personagem*/
        ...
        private void buttonApagar_Click(object sender, EventArgs e)
        {
            ...
            var linhaSelecioanda = dataGridView1.SelectedRows[0];

            var id = Convert.ToInt32(linhaSelecioanda.Cells[0].Value);
