...
SELECT AVG(ataque) AS 'Média dos ataques'
	FROM pokemons;
...
-- Condição: código estiver no intervalo de 50 a 100
-- Coluna: categoria
-- Valor: Seed
UPDATE pokemons
	SET categoria = 'seed'
...
-- Condição: nome começar com R
-- Coluna: nome
-- Valor: trocar primeira letra por C

-- Condição: altura for 0.5
-- Coluna: altura, peso
-- Valor: 0.51, 0.70
...
-- Condição: defesa especial for 3 e ataque especial for 4
-- Coluna: código, defesa, ataque, ataque especial, defesa especial
-- Valor: 1, 1, 1, 3, 4
